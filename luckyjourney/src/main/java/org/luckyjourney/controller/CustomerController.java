...
public class CustomerController {
    ...
    public R getFavorites(@PathVariable Long id){
        ...
        return R.ok().data(favoritesService.getOne(
                new LambdaQueryWrapper<Favorites>().eq(Favorites::getUserId,userId).eq(Favorites::getId,id)
        ));
    }
...
//            userModel.setModels(Collections.singletonList(model));
            ...
            UserModel userModel = UserModel.buildUserModel(list, model.getVideoId(), model.getScore());
